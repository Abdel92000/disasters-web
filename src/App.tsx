...
export default function App() {
  ...
  //   };
  //   document.readyState === "complete" ? loadAssets() : window.addEventListener("load", loadAssets, { once: true });
  // }, []);
  ...
  useEffect(() => {
    ...
    const computeStats = () => {
      ...
      const imgWeight = resources
        .filter(
          (r) => r.initiatorType === "img" || r.initiatorType === "css" || /\.(jpg|jpeg|png|gif|webp)$/i.test(r.name),
        )
        .reduce((sum, r) => sum + (r.transferSize || 0), 0);
  ...
  useEffect(() => {
    const po = new PerformanceObserver((list) => {
      ...
      const isImg = (r: PerformanceResourceTiming) =>
        r.initiatorType === "img" || r.initiatorType === "css" || /\.(avif|jpe?g|png|gif|webp|svg)$/i.test(r.name);
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        <header className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Plateforme d'entraînement avancée pour l'optimisation web et l'éco-conception
          </p>
        </header>
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-16">
          <Card
            ...
            tone={color(stats.bundle, limits.weight)}
          ...
          <Card
            ...
            tone={color(stats.weight, limits.weight)}
          ...
          <Card
            ...
            title="DOM"
            value={stats.dom}
            tone={color(stats.dom, limits.dom)}
            tip="nombre de nœuds"
          />
          <Card
            ...
            tone={color(stats.resources, limits.resources)}
